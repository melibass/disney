# **DISNEY API para Challenge Node.js de Alkemy** 




Desarrollo de una API con MVC para el Challenge de aceleracion de NOde.js<br>
Tecnologias:

Node.js, Express, JavaScript, API Rest, MySQL, Sequelize, Nodemailer, JWT y pruebas con POSTMAN
